    ...
    <main className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h3 className="text-xl sm:text-xl text-gray-300 mb-12 max-w-2xl mx-auto uppercase tracking-[0.3em]">
            Powered by OpenAI Codex Agents
          </h3>

          <p className="text-xl sm:text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Turn your ideas into production-ready code in minutes with OpenAI's
            latest code generation and deployment tooling.
          </p>
